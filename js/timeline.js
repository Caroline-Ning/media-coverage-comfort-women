...
(() => {
              ...
              Vt = function (t) {
                (Zt && Zt === t) ||
                  ...
                  Ft &&
                    ...
                    !0 === Ft.svg && (x(wt, L), x(xt, O), x(xt, R)),
                    !0 === Ft.svgFilters && (x(wt, D), x(xt, O), x(xt, R)),
                    !0 === Ft.mathMl && (x(wt, N), x(xt, j), x(xt, R))),
            ...
            return (
              (i.sanitize = function (t, s) {
                ...
                if (
                  ...
                  if (!Ot && !Nt && !At && -1 === t.indexOf("<"))
                    return st && zt ? st.createHTML(t) : t;
                  if (!(n = oe(t))) return Ot ? null : nt;
                }
  ...
  (() => {
    ...
    function E(t) {
      M[t.toLowerCase()] && (t = M[t.toLowerCase()]),
        (t = t.replace(
          /^#?([a-f\d])([a-f\d])([a-f\d])$/i,
          function (t, e, i, a) {
            return e + e + i + i + a + a;
    ...
    function z(t) {
      t = (t = j(t)).toLowerCase();
      for (
        var e = "ãàáäâẽèéëêìíïîõòóöôùúüûñç·/_,:;", i = 0, a = e.length;
        i < a;
        i++
      )
        t = t.replace(
    ...
    const W = (t) => {
      ...
      G = (t) =>
        null !== t.w && "" !== t.w
          ...
          : 0;
    let Z =
      ((V = (Y = "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ")
        .length),
      {
        encode: function (t) {
          ...
          for (var e = ""; t; ) {
            var i = t % V;
            (t = Math.floor(t / V)), (e = Y[i].toString() + e);
          }
          return e;
        },
        decode: function (t) {
          ...
          for (var e = 0; t; ) {
            ...
            var a = t.length - 1;
            (e += i * Math.pow(V, a)), (t = t.substring(1));
          }
          return e;
        },
      });
    ...
    at.extend = function (t) {
      ...
      this))
        this.hasOwnProperty(s) &&
          ...
          (e[s] = this[s]);
      return (
        t.statics && (D(e, t.statics), delete t.statics),
        t.includes &&
          (D.apply(null, [a].concat(t.includes)), delete t.includes),
        t.options && a.options && (t.options = D({}, a.options, t.options)),
        D(a, t),
        (e.extend = at.extend),
    ...
    class st {
      on(t, e, i) {
        if (!e) throw new T("No callback function provided");
      ...
      fire(t, e) {
        ...
        for (
          ...
          a[s].action
            ...
            : N(`no action defined for ${t} listener`);
        return this;
      }
    }
    function nt(t, e) {
    ...
    class rt {
      ...
      animatePosition(t, e) {
        ...
        this.animator && this.animator.stop(), (this.animator = nt(e, i));
      }
      onLoaded() {
    ...
    class lt {
      ...
      _onDragStart(t) {
        f
          ...
          (this.data.pos.start = y(this._el.drag)),
      ...
      _onDragMove(t) {
        t.preventDefault(),
          ...
          (this.data.pos.end = y(this._el.drag)),
          (this.data.new_pos.x = -(
      ...
      _animateMomentum() {
        var t = { x: this.data.new_pos.x, y: this.data.new_pos.y },
          e = { duration: this.options.duration, easing: et };
        this.options.enable.y &&
          ...
          (this.animator = nt(this._el.move, e)),
    ...
    var ht,
      dt = {
        addListener: function (t, e, i, a) {
          ...
          if (!t[n]) {
            var o = function (e) {
              return i.call(a || t, e || dt._getEvent());
            };
            if (f && "dblclick" === e && this.addDoubleTapListener)
              ...
              if ("mousewheel" === e)
                ...
                (o = function (e) {
                  if (dt._checkMouse(t, e)) return r(e);
                }),
        ...
        disableClickPropagation: function (t) {
          dt.addListener(t, lt.START, dt.stopPropagation),
            dt.addListener(t, "click", dt.stopPropagation),
            dt.addListener(t, "dblclick", dt.stopPropagation);
        },
        preventDefault: function (t) {
          t.preventDefault ? t.preventDefault() : (t.returnValue = !1);
        },
        stop: function (t) {
          dt.preventDefault(t), dt.stopPropagation(t);
        },
          ...
          (i.fn = {
            ...
            attr: function (i, a) {
              ...
              return "string" == typeof i && a === t
                ...
                : this.each(function (t) {
                    if (1 === this.nodeType)
                      if (O(i)) for (e in i) U(this, e, i[e]);
    ...
    (window.Zepto = ct),
      ...
      ((ht = ct).fn.serializeArray = function () {
        var t,
          e = [];
        return (
          ht([].slice.call(this.get(0).elements)).each(function () {
            var i = (t = ht(this)).attr("type");
      ...
      (ht.fn.submit = function (t) {
        if (t) this.bind("submit", t);
        else if (this.length) {
          var e = ht.Event("submit");
    ...
    const ut = ct.getJSON,
      ...
      ft = ["millisecond", "second", "minute", "hour", "day", "month", "year"],
      gt = /^([\+-]?\d+?)(-\d{2}?)?(-\d{2}?)?$/,
      vt =
      ...
      bt = at.extend({
        ...
        getDisplayDate: function (t, e) {
          ...
          t || (t = At.fallback),
            t.constructor != At &&
              (N("First argument to getDisplayDate must be type Language"),
              (t = At.fallback));
        ...
        floor: function (t) {
          for (
            ...
            if ((pt[i][2](e), pt[i][0] == t)) return new bt(e);
          throw new T("invalid_scale_err", t);
        },
        _getDateData: function () {
          ...
          for (var e in (L(t, this.data), ft)) {
            if (!j(t[ft[e]]).match(/^-?\d*$/))
              throw new T("invalid_date_err", ft[e] + " = '" + t[ft[e]] + "'");
            var i = parseInt(t[ft[e]]);
            isNaN(i) && (i = 4 == e || 5 == e ? 1 : 0), (t[ft[e]] = i);
          }
        ...
        findBestFormat: function (t) {
          for (var e = ft, i = 0; i < e.length; i++)
            if (this.data[e[i]])
              return t ? t in yt || (t = "short") : (t = "base"), yt[t][e[i]];
          return "";
        },
    ...
    function wt(t) {
      ...
      if (t.match(vt)) return cls.parseISODate(t);
    ...
    const kt = at.extend({
        initialize: function (t) {
          if (((this.year = parseInt(t)), isNaN(this.year)))
            throw new T("invalid_year_err", t);
        },
        isBefore: function (t) {
    ...
    function Lt(t) {
      return function (e) {
        var i = e.getTime();
        return new kt(Math.floor(i / t) * t);
      };
    }
    const Dt = [
        ["year", 1, new Lt(1)],
        ["decade", 10, new Lt(10)],
        ["century", 100, new Lt(100)],
        ["millennium", 1e3, new Lt(1e3)],
        ["age", xt, new Lt(xt)],
        ["epoch", Tt, new Lt(Tt)],
        ["era", Mt, new Lt(Mt)],
        ["eon", Et, new Lt(Et)],
      ...
      St = bt.extend({
        ...
        _createDateObj: function () {
          var t = this._getDateData();
          this.data.date_obj = new kt(t.year);
        },
        floor: function (t) {
    ...
    class At {
      ...
      mergeData(t) {
        for (k in Ot.en)
          t[k] &&
            ("object" == typeof this[k] ? L(t[k], this[k]) : (this[k] = t[k]));
      }
      formatBigYear(t, e) {
        var i = t.year,
        ...
        return (
          N("Language file dateformats missing cosmological. Falling back."),
          Ct(i, e)
        );
      }
      _(t, e) {
        ...
        if (i.match(Nt)) {
          if (!e) throw new T("template_message_without_context");
          for (let t of i.matchAll(Nt)) {
            if (!(t[1] in e)) throw new T("template_message_without_context");
      ...
      formatDate(t, e) {
        return t.constructor == Date
          ...
          : (N("Unfamiliar date presented for formatting"), t.toString());
      }
      formatJSDate(t, e) {
        var i = this,
          a = function (t, e) {
    ...
    class zt {
      ...
      _initEvents() {
        dt.addListener(this._el.container, "click", this._onMouseClick, this),
          dt.addListener(this, "removed", this._onRemove, this);
      }
    }
    function Pt(t, e) {
      (e = e || "start_date"),
    ...
    function Ht(t) {
      ...
      if (
        ...
        throw new T("invalid_separator_error");
      let o = s[0];
      if (
        ((e.hour = parseInt(o)),
        ...
        throw new T("invalid_hour_err", o);
      if (s.length > 1) {
        let t = s[1];
        if (((e.minute = parseInt(t)), isNaN(e.minute)))
          throw new T("invalid_minute_err", t);
      }
      if (s.length > 2) {
        var r = s[2].split(/[\.,]/);
        if ((s = r.concat(s.slice(3))).length > 2)
          throw new T("invalid_second_fractional_err");
        if (((e.second = parseInt(s[0])), isNaN(e.second)))
          throw new T("invalid_second_err", s[0]);
        if (2 == s.length) {
          var l = parseInt(s[1]);
          if (isNaN(l)) throw new T("invalid_fractional_err", s[1]);
          e.millisecond = 100 * l;
        }
      }
      return e;
    ...
    const $t = { human: bt, cosmological: St };
    var Bt = i(856),
      Ut = i.n(Bt);
    const Wt = { text: ["headline", "text"], media: ["caption", "credit"] },
      Gt = {
    ...
    class Vt {
      ...
      logError(t) {
        N(`logError: ${t}`), this.messages.errors.push(t);
      }
      getErrors(t) {
      ...
      addEvent(t, e) {
        ...
        return void 0 === t.start_date
          ? (N("Missing start date, skipping event"), console.log(t), null)
      ...
      addEra(t) {
        ...
        if (void 0 === t.start_date) throw new T("missing_start_date_err", e);
        this._processDates(t),
          this._tidyFields(t),
          this.eras.push({
      ...
      _assignID(t) {
        var e = t.unique_id;
        return (
          j(e) || (e = t.text ? z(t.text.headline) : null),
      ...
      _makeUniqueIdentifiers(t, e) {
        ...
        if (i.length != e.length + 1)
          for (a = 0; a < e.length; a++)
            if (!e[a].unique_id) {
              var s = e[a].text ? z(e[a].text.headline) : null;
              s || (s = P(6)),
                -1 != i.indexOf(s) && (s = s + "-" + a),
                i.push(s),
                (e[a].unique_id = s);
      ...
      _ensureValidScale(t) {
        if (!this.scale) {
          ...
          N(`Determining scale dynamically: ${this.scale}`);
        }
        $t[this.scale] ||
          this.logError(
    ...
    async function te(t, e) {
      ...
      (t = (function (t) {
        ...
        throw new T("invalid_url_err", t);
      })(t)),
        await (async function (t) {
          return new Promise((e, i) => {
            if (t.data) {
              var a = Jt(Xt(t.data, t), t);
      ...
      return (
        i.forEach((t, e) => {
          try {
            if (
              ...
              let e = (function (t) {
                ...
                if (
                  ...
                  e["Start Date"] && (a.start_date = wt(e["Start Date"])),
                    e["End Date"] && (a.end_date = wt(e["End Date"]));
                else {
                  if (
                    (e.Year &&
                      (a.start_date = {
                    ...
                    e["End Year"] &&
                      (a.end_date = {
                        year: Kt(e["End Year"]) || "",
                        month: Kt(e["End Month"]) || "",
                        day: Kt(e["End Day"]) || "",
                      }),
                    e.Time)
                  ) {
                    if (!a.start_date)
                      throw new T("invalid_start_time_without_date");
                    L(a.start_date, Ht(e.Time));
                  }
                  if (e["End Time"]) {
                    if (!a.end_date)
                      throw new T("invalid_end_time_without_date");
                    L(a.end_date, Ht(e["End Time"]));
                  }
                  if (a.start_date && !Ft(a.start_date))
                    throw new T("invalid_date_err");
            ...
            if (i.constructor == T) a.errors.push(i);
            else {
    ...
    class ee {
      constructor(t) {
        if (!t) throw new T("axis_helper_no_options_err");
    ...
    ae("human", pt), ae("cosmological", Dt);
    const se = {
    ...
    class ne {
      constructor(t, e) {
        ...
        (this._scale = t.scale),
          ...
          (this._axis_helper = (function (t, e) {
            ...
            var i = t.getScale(),
              a = ie[i];
            if (!a) throw new T("axis_helper_scale_err", i);
      ...
      _computeDefaultSpan(t) {
        if ("human" == t.scale) {
          ...
          for (i = pt.length - 1; i >= 0; i--)
            if (e.hasOwnProperty(pt[i][0])) {
              var s = pt[pt.length - 1];
              return pt[i + 1] && (s = pt[i + 1]), s[1];
            }
          return 31536e6;
        }
        return 2e5;
      ...
      getDateFromTime(t) {
        if ("human" == this._scale) return new bt(t);
        if ("cosmological" == this._scale) return new St(new kt(t));
        throw new T("time_scale_scale_err", this._scale);
      }
      getMajorScale() {
    ...
    class re {
      ...
      setRowPosition(t, e) {
        this.setPosition({ top: t }),
          e < 56 &&
            x(this._el.content_container, "tl-timeera-content-container-small");
      }
      setColor(t) {
    ...
    class le {
      constructor(t, e, i) {
        i && this.setLanguage(i),
          ...
          (this._state = { loaded: !1 }),
          (this.data = {}),
          (this.options = { duration: 1e3, ease: tt, width: 600, height: 600 }),
          (this.active = !1),
          (this.animator = {}),
          (this.axis_helper = {}),
          (this.minor_ticks = []),
      ...
      loadMedia() {
        ...
        if (!this._state.loaded)
          try {
            ...
            N("Error loading media for ", this._media), N(t);
          }
      }
      _updateMessage(t) {
        ...
        (this.youtube_loaded = !1),
          ...
          this.data.url.match("v=")
            ...
            ? (this.media_id.id = this.data.url
                ...
                .split(/[?&]/)[0])
            : N("YOUTUBE IN URL BUT NOT A VALID VIDEO"),
          this.data.url.match("start=")
            ? (this.media_id.start = J(this.data.url.split("start=")[1]))
            : this.data.url.match("t=") &&
              (this.media_id.start = J(this.data.url.split("t=")[1])),
          this.data.url.match("end=") &&
            (this.media_id.end = J(this.data.url.split("end=")[1])),
    ...
    class fe extends de {
      ...
      _updateMediaDisplay() {
        if (this._state.loaded) {
          var t = W({ w: this._el.content_item.offsetWidth });
    ...
    class be extends de {
      ...
      _updateMediaDisplay() {
        this._el.content_item.style.height =
          G({ w: this._el.content_item.offsetWidth }) + "px";
      }
      _stopMedia() {
        try {
          this.player &&
    ...
    class Me extends de {
      ...
      establishMediaID() {
        if (this.data.url.match(/flic.kr\/.+/i)) {
          ...
          if (-1 == i) throw new T("flickr_invalidurl_err");
          var a = i + e.length;
        ...
        (this._el.content_item = this.domCreate(
          ...
          this.data.url.match(/\.html$/)
            ...
            : this.data.url.match(/.(json|js)$/) ||
              N("DOCUMENT CLOUD IN URL BUT INVALID SUFFIX"),
          ue(
            [
    ...
    class Ne extends de {
      ...
      getImageURL() {
        ...
        _t(`${Le}${this.data.url}`)
          ...
          .catch((t) => {
            N(`Instagram getImageURL Error: ${t.status} ${t.statusText}`);
          });
      }
      _getMeta() {
          ...
          mt({
            ...
            success: function (e) {
              try {
                ...
                N("Error processing imgur ajax response");
              }
            },
    ...
    class He extends de {
      _loadMedia() {
        ...
        (this._el.content_item = this.domCreate(
          ...
          N(`Wistia: media_id: ${this.media_id}`),
          (t =
    ...
    function qe(t, e) {
      var i = [
        ...
        { type: "iframe", name: "iFrame", match_str: "iframe", cls: Oe },
    ...
    class Fe {
      ...
      _initEvents() {
        dt.addListener(this._el.container, "click", this._onMarkerClick, this),
          dt.addListener(
            this._el.container,
            "keydown",
          ...
          dt.addListener(this._el.container, "blur", this._onMarkerBlur, this);
      }
      _updateDisplay(t, e, i) {
        t && (this.options.width = t), e && (this.options.height = e);
      }
      ...
      _momentum() {
        ...
        (this.data.direction = null),
          ...
          a && this.data.direction
            ...
            : this.options.snap &&
              (this.animator.stop(),
              (this.animator = nt(this._el.move, {
    ...
    class Be {
      ...
      _getTimeScale() {
        ...
        try {
          ...
          N("Invalid value for marker_height_min option."), (t = 30);
        }
        return (
          0 == t && (N("marker_height_min option must not be zero."), (t = 30)),
        ...
        if (this.options.has_groups)
          for (
            ...
            s > t - this.options.marker_padding && (n = !0),
              ...
              this._groups[i].setAlternateRowColor(H(i), n),
      ...
      _findMarkerIndex(t) {
        ...
        return (
          ("string" == typeof t || t instanceof String) &&
            (e = q(t, this._markers, "unique_id", e)),
          e
        );
      }
      _createEras(t) {
          ...
          e
            ...
            ? ((this._el.slider.className =
              ...
              (this._el.slider.style.left =
                -this._markers[t].getLeft() + this.options.width / 2 + "px"))
            : ((this._el.slider.className = "tl-timenav-slider"),
              (this.animator = nt(this._el.slider, {
                left:
                  -this._markers[t].getLeft() + this.options.width / 2 + "px",
                duration: a,
                easing: s,
      ...
      _onKeydown(t) {
        switch ((dt.stopPropagation(t), t.key)) {
          case "ArrowUp":
          case "ArrowRight":
            this.focusNext();
            break;
      ...
      _initEvents() {
        this._swipable.on("dragmove", this._onDragMove, this),
          ...
          dt.addListener(this._el.container, "keydown", this._onKeydown, this);
      }
      _initData() {
    ...
    class Ue {
      ...
      show() {
        this.animator = nt(this._el.slider_container, {
        ...
        this.data.media &&
          ...
          this.has.text || this.has.headline || !this.has.media
            ? this.has.headline && this.has.media && !this.has.text
              ? (w(this._el.container, "tl-slide-media-only"),
              ...
              ? (this._text.addTo(this._el.content),
                this._media.addTo(this._el.content))
              : (this.has.text || this.has.headline) &&
                (w(this._el.container, "tl-slide-text-only"),
                this._text.addTo(this._el.content))
            : (w(this._el.container, "tl-slide-media-only"),
              this._media.addTo(this._el.content)),
          this.onLoaded();
    ...
    class Ge {
      ...
      changeBackground(t) {
        ...
        t.color_value && "" != t.color_value
          ? (e = E(t.color_value)) ||
            (N("Invalid color value " + t.color_value),
      ...
      _initLayout() {
        w(this._el.container, "tl-storyslider"),
      ...
      _onSlideAdded(t) {
        N("slideadded"), this.fire("slideAdded", this.data);
      }
      _onSlideRemoved(t) {
        ...
        if (this._loaded) {
          ...
          (e =
            ...
            this.hasEventListeners(e) &&
              ("contextmenu" === e && dt.preventDefault(t),
              this.fire(e, {
                latlng: "something",
    ...
    class Ze {
      ...
      _initLayout() {
        (this._el.button_zoomin = v(
          "button",
          "tl-menubar-button",
          this._el.container
        )),
          (this._el.button_zoomout = v(
            "button",
            "tl-menubar-button",
            this._el.container
          )),
          (this._el.button_forwardtoend = v(
            "button",
            "tl-menubar-button",
            this._el.container
          )),
          (this._el.button_backtostart = v(
            "button",
            "tl-menubar-button",
            this._el.container
          )),
    ...
    class Ve {
      constructor(t, e, i) {
        if (
          ...
          (this.message = new zt(this._el.container, {
            message_class: "tl-message-full",
          })),
          "string" == typeof i.default_bg_color)
        ) {
          var a = E(i.default_bg_color);
          a
            ? (i.default_bg_color = a)
            : (delete i.default_bg_color,
              N("Invalid default background color. Ignoring."));
        }
        var s, n;
        L(this.options, i),
          ...
          this.options.is_embed && w(this._el.container, "tl-timeline-embed"),
          this.options.is_full_embed &&
            w(this._el.container, "tl-timeline-full-embed"),
              ...
              if (Qt(t)) {
                try {
                  n = await (async function (t, e) {
                    ...
                    var i = await te(t, e.sheets_proxy);
                    if (i) return i;
                  })(t, a);
                } catch (t) {
                  return (
                    (s = new Vt()),
                    "NetworkError" == t.name
                      ? s.logError(new T("network_err"))
                      : "TLError" == t.name
                      ? s.logError(t)
                      : s.logError(new T("unknown_read_err", t.name)),
                    void i(s)
                  );
                }
                ...
                mt({
                  ...
                  error: function (t, e, a) {
                    (s = new Vt()),
                      (a =
                        "parsererror" == e
                          ? new T("invalid_url_err")
                          : new T("unknown_read_err", e)),
                      s.logError(a),
                      i(s);
                  },
                });
      ...
      _translateError(t) {
        return (
          t.hasOwnProperty("stack") && N(t.stack),
          t.message_key
      ...
      showMessage(t) {
        this.message
          ...
          : (N("No message display available."), N(t));
      }
      determineScriptPath() {
        let t = null;
        if (Ye) t = Ye;
        ...
        i && (n = i),
          ...
          e
            ? ((this._el.timenav.style.height =
              ...
              (this.animator_storyslider = nt(this._el.storyslider, {
                height: this.options.storyslider_height + "px",
                duration: n / 2,
                easing: et,
              })),
              this.animator_menubar && this.animator_menubar.stop(),
              (this.animator_menubar = nt(this._el.menubar, {
                top: s + "px",
                duration: n / 2,
                easing: et,
              })))
      ...
      updateDisplay() {
        this.ready
          ? this._updateDisplay()
          : N("updateDisplay called but timeline is not in ready state");
      }
      focusContainer() {
